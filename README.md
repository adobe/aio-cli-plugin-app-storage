...
GLOBAL FLAGS
  --json            Format output as json.
  --region=<value>  Database region. Has no effect if region is set in the app.config.yaml application manifest.
